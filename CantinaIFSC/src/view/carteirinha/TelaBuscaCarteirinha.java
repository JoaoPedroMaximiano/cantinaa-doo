 ...
 * @author aluno
 */
public class TelaBuscaCarteirinha extends javax.swing.JFrame {

    /**
     * Creates new form TemplateBuscas2023
     */
    public TelaBuscaCarteirinha() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaCarteirinha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaBuscaCarteirinha().setVisible(true);
            }
        });
    }
